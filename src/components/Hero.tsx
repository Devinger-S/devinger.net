...
export default function Hero() {
  ...
  return (
    <div className="flex flex-col lg:flex-row  mx-auto  justify-around   w-full mt-20 mb-10  overflow-hidden">
      {/* Text container */}
      ...
      <div className="max-w-3xl   text-center md:text-left ">
        <RoughNotationGroup show={true}>
          ...
          <RainbowHighlight color={colors[0]}>
            <h1 className="text-[1.8em] sm:text-[4em] xl:text-[6em] font-bold text-[#c6d0f5]  my-2">
              Programmer.
            </h1>
          </RainbowHighlight>
