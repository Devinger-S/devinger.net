...
export default function AboutMe() {
  return (
    <div className=" relative">
        ...
        <h1 
        className="text-4xl sticky -z-10 top-0 left-4 drop-shadow-2xl dark:shadow-lg  text-background dark:text-gray-300/10  dark:shadow-indigo-500/40 relative md:text-8xl lg:text-9xl font-bold   text-left"
        >
         About me
        </h1>
      ...
      <div className=" z-2 mt-8 opacity-95 grid grid-cols-1 md:grid-cols-3  mx-auto gap-y-20 gap-x-20">
        {/* Social Buttons */}
